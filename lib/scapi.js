...
##################################################################################*/
  ...
  GetSystem: function(systemName, message){
  ...
  GetSystemsRefresh:function(){
    const _URI = systemsAPI;  //No parameters

    return(
      fetch(_URI)
      .then(res=>res.json())
      .then(results=>{return results})
      .catch(err=>console.log(`Error calling SYSTEM API for refresh => ${err}`))
    )
  },
  GetTunnelsRefresh:function(){
    const _URI = tunnelsAPI;  //No parameters

    return(
      fetch(_URI)
      .then(res=>res.json())
      .then(results=>{return results})
      .catch(err=>console.log(`Error calling TUNNELS API for refresh => ${err}`))
    )
  },
  GetSpeciesRefresh:function(){
    const _URI = speciesAPI;  //No parameters

    return(
      fetch(_URI)
      .then(res=>res.json())
      .then(results=>{return results})
      .catch(err=>console.log(`Error calling SPECIES API for refresh => ${err}`))
    )
  },
  GetAffiliationsRefresh:function(){
    const _URI = affiliationsAPI;  //No parameters

    return(
      fetch(_URI)
      .then(res=>res.json())
      .then(results=>{return results})
      .catch(err=>console.log(`Error calling AFFILIATIONS API for refresh => ${err}`))
    )
  },
  GetObjectsRefresh:function(){
    const _URI = objectsAPI;  //No parameters

    return(
      fetch(_URI)
      .then(res=>res.json())
      .then(results=>{return results})
      .catch(err=>console.log(`Error calling OBJECTS API for refresh => ${err}`))
    )
  }
}
